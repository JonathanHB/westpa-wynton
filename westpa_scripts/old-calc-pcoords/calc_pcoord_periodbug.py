...
# The first structure (state1) defines the 0 value of the progress coordinate.
def calc_progress_coord_component(state1, state2, resseqs_s1, resseqs_s2, frame):
    ...
    fractional_pc = elementwise_matrix_rmsd(distance_matrix_frame, distance_matrix_s1)/pc_component_s1s2
...
inputpath = "/wynton/home/grabe/jborowsky/aac1/westpa-04/westpa_scripts/pcoord-ref-structures"
...
link_rc = calc_progress_coord_component(bov_cstate_structure, fun_mstate_structure, bov_linker_resseqs, fun_linker_resseqs, frame)

#2d progress coordinate
print(f"{cyt_pc} {mat_pc} {link_pc}")
